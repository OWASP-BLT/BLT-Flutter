class AppUrl {
  ...
  static const String login = liveStagingURL + "/auth/login/";
  static const String register = liveStagingURL + "/auth/registration/";
  static const String forgotPassword = baseURL + "/forgot-password";
  static const String user = liveStagingURL + "/auth/user/";
}
