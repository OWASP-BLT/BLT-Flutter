...
class StartBugHunt extends StatefulWidget {
  @override
  _StartBugHuntState createState() => _StartBugHuntState();
}

class _StartBugHuntState extends State<StartBugHunt> {
  ...
  Future<void> _redirectDialog(BuildContext context) {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Redirecting to Bug Page'),
          actions: <Widget>[
            TextButton(
              child: Text('Ok'),
              onPressed: () {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      "*Press Start Hunt to choose a plan",
                    ),
                    Padding(
                      padding: const EdgeInsets.fromLTRB(30.0, 15.0, 0.0, 3.0),
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                uploadBtnPress();
                                Navigator.pushNamed(context, '/pricing_page');
                              },
                            ),
                          ),
                        ],
